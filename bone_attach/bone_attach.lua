...
function sendAttachmentData()
  ...
  triggerClientEvent(client, "boneAttach_sendAttachmentData", root, attached_ped, attached_bone, attached_x, attached_y, attached_z, attached_rx, attached_ry, attached_rz)
